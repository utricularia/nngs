...
#define ENG(n_,s_) formats_english[n_] = s_
#define CHI(n_,s_) formats_chinese[n_] = s_
#define GER(n_,s_) formats_german[n_] = s_
void language_init(void)
{
#else /* WANT_TO_DEFINE */
#define ENG(n_,s_) /*  eng [n_] = s_; */
#define CHI(n_,s_) /*  chi [n_] = s_; */
...
#define FORMAT_THE_PLAYER_s_IS_NOW_IN_BYO_YOMI_ 72
ENG(FORMAT_THE_PLAYER_s_IS_NOW_IN_BYO_YOMI_,"The player %s is now in byo-yomi.");
GER(FORMAT_THE_PLAYER_s_IS_NOW_IN_BYO_YOMI_,"Der Spieler %s ist jetzt in byo-yomi.");
...
CHI(FORMAT_d_PLAYERS_FOUND_n,"找到 %d 位使用者.\n");
...
CHI(FORMAT_LOGINS_d_LOGOUTS_d_NEW_PLAYERS_dn,"進站人次: %d   離站人次: %d   新註冊使用者: %d\n");
